...
import {POOL_MANAGER, USDC} from "../../../src/uniswap-v4/Constants.sol";
...
contract SwapTest is Test, TestHelper {
    ...
    function setUp() public {
        ...
        swap = new Swap(POOL_MANAGER); // Initializing the declared instance (swap) of the Swap contract above
