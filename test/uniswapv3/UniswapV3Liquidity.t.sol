...
// A test contract to interact with UniswapV3NonFungiblePositionManager Liquidity management functions
...
contract UniswapV3LiquidityTest is Test {
    ...
    // DAI/WETH 3000 ( the DAI/WETH POOL with a 0.3% swap fee tier)
    ...
    // not exceeding this contract's balance
    ...
    // Some of the tokens were used to mint a new position
